import os
from utils import load_json_file, water_filling_spine_leaf
...
if __name__ == "__main__":
    ...
    network_data_filename = "spine8_leaf8_servers64_jobs8_seed42.json"
    ...
    for baseline_name in baseline_names:
        ...
        # Use the water_filling_spine_leaf function to calculate throughput
        job_throughputs = water_filling_spine_leaf(network_config, results)
